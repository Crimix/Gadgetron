...
public class GuiFabricator extends GuiContainerBase {
	private static final ResourceLocation gui = new ResourceLocation("gadgetron:textures/gui/fabricator.png");
	...
	private GuiElement arrow = new GuiElement("arrow", 86, 34, 17, 24, 176, 14);
	...
	protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
		String s = I18n.format("gadgetron.container.fabricator");
