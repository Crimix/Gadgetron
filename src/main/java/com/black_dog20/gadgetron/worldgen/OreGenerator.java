	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
		if(raritanium.generate && !Helper.IntArrayContains(raritanium.dimBlacklist,world.provider.getDimension()))
			for(int i = 0; i < raritanium.perChunk; i++)
			{
				...
				new WorldGenMinable(ModBlocks.RaritaniumCrystal.getDefaultState(),raritanium.veinMax, BlockMatcher.forBlock(Blocks.STONE)).generate(world, random, pos);
			}
		...
		if(adamantine.generate && !Helper.IntArrayContains(adamantine.dimBlacklist,world.provider.getDimension()))
			for(int i = 0; i < adamantine.perChunk; i++)
			{
				...
				new WorldGenMinable(ModBlocks.AdamantineOre.getDefaultState(), adamantine.veinMax, BlockMatcher.forBlock(Blocks.STONE)).generate(world, random, pos);
			}
		...
		if(carbonox.generate && !Helper.IntArrayContains(carbonox.dimBlacklist,world.provider.getDimension()))
			for(int i = 0; i < carbonox.perChunk; i++)
			{
				...
				new WorldGenMinable(ModBlocks.CarbonoxOre.getDefaultState(), carbonox.veinMax, BlockMatcher.forBlock(Blocks.STONE)).generate(world, random, pos);
			}
		...
		if(trillium.generate && !Helper.IntArrayContains(trillium.dimBlacklist,world.provider.getDimension()))
			for(int i = 0; i < trillium.perChunk; i++)
			{
				...
				new WorldGenMinable(ModBlocks.TrilliumOre.getDefaultState(), trillium.veinMax, BlockMatcher.forBlock(Blocks.STONE)).generate(world, random, pos);
			}
		...
		if(titanium.generate && !Helper.IntArrayContains(titanium.dimBlacklist,world.provider.getDimension()))
			for(int i = 0; i < titanium.perChunk; i++)
			{
				...
				new WorldGenMinable(ModBlocks.TitaniumOre.getDefaultState(), titanium.veinMax, BlockMatcher.forBlock(Blocks.STONE)).generate(world, random, pos);
			}
