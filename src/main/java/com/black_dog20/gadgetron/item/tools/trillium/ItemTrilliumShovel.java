...
public class ItemTrilliumShovel extends ItemShovelBase implements IItemModelRegister, IElementType{

	public ItemTrilliumShovel(String name, ToolMaterial material) {
		super(material);
